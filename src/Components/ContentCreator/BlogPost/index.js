...
function ContentCreatorBlogCard({ id, status, img, title, description, author, posted_on, setModalOpen }) {
  ...
  const blogList = [
    { id: "edit", name: "Edit",  type: "func", func: () => navigate(`/${getUserType()}/blogs/edit/${id}`) },
    { id: "delete", name: "Delete", type: "func", func: deletePost },
  ];  
